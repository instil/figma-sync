...
import {webOutputFiles} from "@src/saving/platforms/web/style-dictionary/output/WebOutputFiles";

export function saveWebStyleDictionary(tokens: DesignToken): void {
